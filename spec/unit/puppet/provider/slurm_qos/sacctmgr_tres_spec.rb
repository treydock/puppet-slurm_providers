  ...
  describe 'self.prefetch' do
    it 'should populate @property_hash' do
      ...
      @instance.instance_variable_get(:@property_hash).should == {
        ...
        :grp_tres_mins => 'cpu=-1,energy=-1,mem=-1,node=-1',
        :grp_tres_run_mins => 'cpu=-1,energy=-1,mem=-1,node=-1',
        :grp_tres => 'cpu=-1,energy=-1,mem=-1,node=-1',
        :max_tres_mins => 'cpu=-1,energy=-1,mem=-1,node=-1',
        :max_tres_per_job => 'cpu=-1,energy=-1,mem=-1,node=-1',
        :max_tres_per_node => 'cpu=-1,energy=-1,mem=-1,node=-1',
        :max_tres_per_user => 'cpu=-1,energy=-1,mem=-1,node=-1',
        :min_tres_per_job => 'cpu=1,energy=-1,mem=-1,node=-1',
      }
    end
  end
  ...
  describe 'set_values' do
    it 'should return Array of values for sacctmgr' do
      @resource.provider.set_values.should match_array([
        ...
        'grptresmins=cpu=-1,energy=-1,mem=-1,node=-1', 'grptresrunmins=cpu=-1,energy=-1,mem=-1,node=-1',
        'grptres=cpu=-1,energy=-1,mem=-1,node=-1', 'maxtresmins=cpu=-1,energy=-1,mem=-1,node=-1',
        'maxtresperjob=cpu=-1,energy=-1,mem=-1,node=-1', 'maxtrespernode=cpu=-1,energy=-1,mem=-1,node=-1',
